...
public class LiveStreaming extends BaseFragment implements View.OnClickListener {
    ...
    private Button latency;
    TextView publish,join;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_live_streaming, container, false);
        return view;
    }
...
//                CommonUtil.hideInputBoard(getActivity(), et_channel);
    ...
    private void joinChannel(String channelId) {
        ...
        String accessToken = ClassUtils.readPrefString(getContext(),"token");
//        if (TextUtils.equals(accessToken, "") || TextUtils.equals(accessToken, "006ba84fbae95d545f39cb93f4e3bfd0a90IAAaIn7b08iwdvkiqZBpP/gkR2JB9Gf2i254FX1gQlV8b+IVUyEAAAAAEAALtir+qMSGYAEAAQCmxIZg")) {
//            accessToken = null;
//        }
